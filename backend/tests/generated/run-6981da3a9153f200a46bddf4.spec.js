...
test('[run-6981da3a9153f200a46bddf4] Verify Website Navigation', async ({ page }) => {
...
test('[run-6981da3a9153f200a46bddf4] Test Basic Page Content', async ({ page }) => {
  const url = 'http://localhost:5000/login.html';
  const __CONF = [];
  const DATA = {
  "email": "test@example.com",
...
test('[run-6981da3a9153f200a46bddf4] Test Form Submission', async ({ page }) => {
  const url = 'http://localhost:5000/login.html';
  const __CONF = [];
  const DATA = {
  "email": "test@example.com",
...
test('[run-6981da3a9153f200a46bddf4] Test Responsive Design', async ({ page }) => {
  const url = 'http://localhost:5000/login.html';
  const __CONF = [];
  const DATA = {
  "email": "test@example.com",
